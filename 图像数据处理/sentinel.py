...
class Sentinel_pre_com:
    ...
    def combination_bands_jp2(self, out_dir=None, bands=[2, 3, 4, 8]):
        ...
        seperator = os.sep
        imgs = [file_path + f"{seperator}*{seperator}*{seperator}IMG_DATA{seperator}R{self.resolution}m" + os.sep+ "*B0{}*" for file_path in file_pathes]
...
if __name__ == '__main__':
    ...
    script = "E:\ZYH_work\Sentinel\Sen2Cor-02.08.00-win64\Sen2Cor-02.08.00-win64\L2A_Process.bat"# 脚本路径
